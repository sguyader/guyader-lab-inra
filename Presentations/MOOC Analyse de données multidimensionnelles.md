...
## 1. Données - Problématique
  ...
  - exemple : 10 vins de Loire en individus lignes, descripteurs sensoriels comme variables colonnes (dans chaque cellule, la note moyenne attribuée par des juges pour chaque vin et chaque variable) et une dernière colonne avec la variable cépage (qualitative : Vouvray ou Sauvigon)
...
## 2. Équilibre et ACP globale
  ...
  - on donné un même poids à toutes les variables d'un même groupe, on préserve ainsi la structure (*i.e.* l'équilibre des variables) du groupe
