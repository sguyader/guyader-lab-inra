...
<br><br>
<img src="./images/R_logo.svg.png" alt="license" height="50"/>, <img src="./images/RStudio_Logo.png" alt="license" height="50"/>, <img src="./images/LibreOffice_logo.svg.png" alt="license" height="50"/>**...**
]
...
- test de dépôt de données :
  ...
  * verdict sur data.inra.fr :
    ...
    - **négatif** : manque de souplesse (autorisations, logged in timeout), lenteur d'affichage, infos du dataset sur différentes pages (donc lenteur accrue)
]
