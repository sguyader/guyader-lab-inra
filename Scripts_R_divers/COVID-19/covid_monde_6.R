...
download.file("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv", destfile = "data/covid19_confirmed_10mai2020.csv")
download.file("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv", destfile = "data/covid19_deaths_10mai2020.csv")
download.file("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_recovered_global.csv", destfile = "data/covid19_recovered_10mai2020.csv")
download.file("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/UID_ISO_FIPS_LookUp_Table.csv", destfile = "data/UID_ISO_FIPS_LookUp_Table_10mai2020.csv")

# Charger les identifiants
covid_uid <- read_csv("data/UID_ISO_FIPS_LookUp_Table_10mai2020.csv") %>%
...
# Confirmés
covid_confirmed <- read_csv("data/covid19_confirmed_10mai2020.csv") %>%
...
# Décédés
covid_deaths <- read_csv("data/covid19_deaths_10mai2020.csv") %>%
  rename("Province.State" = "Province/State") %>% rename("Country.Region" = "Country/Region") %>%
  filter(!Country.Region %in% c("Comoros", "Tajikistan"))
...
# Guéris
covid_recovered <- read_csv("data/covid19_recovered_10mai2020.csv") %>%
  rename("Province.State" = "Province/State") %>% rename("Country.Region" = "Country/Region") %>%
  filter(!Country.Region %in% c("Comoros", "Tajikistan"))
