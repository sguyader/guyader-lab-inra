...
library(R.matlab)
source("../R_files/mogi_3D.R")
source("../R_files/wls_ulos.R")
source("../R_files/kernels.R")
...
xstar_norm <- c(0.75, 0.65, 0.75, 0.4736842, 0.52)
...
data <- readMat('../R_files/data_nonoise.mat') # TODO: do a read from cvs version (rodo)
...
# panel.hist fonction for adding histograms to "pairs" the scatterplot matrix
