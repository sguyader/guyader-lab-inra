...
(setq org-directory "~/TRAVAIL/github/guyader-lab-inra/org/")
...
(global-set-key (kbd "C-c j") 
                (lambda () (interactive) (find-file "~/TRAVAIL/github/guyader-lab-inra/org/journal.org")))
(setq org-default-notes-file "~/TRAVAIL/github/guyader-lab-inra/org/notes.org")
     (define-key global-map "\C-cd" 'org-capture)
(setq org-capture-templates (quote (("t" "Todo" entry (file+headline "~/TRAVAIL/github/guyader-lab-inra/org/liste.org" "Tasks") "* TODO %?
  %i
  %a" :prepend t) ("j" "Journal" entry (file+datetree "~/TRAVAIL/github/guyader-lab-inra/org/journal.org") "* %?
Entered on %U
  %i
  %a"))))
