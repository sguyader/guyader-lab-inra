...
**** *Réunion ching*                                                 :CODIR:
Ordre du jour :
- Retour des départements sur les piliers scientifiques d'ASTRO
- Possible nomination et lettre de mission Directeur Adjoint
- Exécution et instruction des projets en cours
- Questions diverses
...
Entered on [2018-11-29 Thu 13:17]
  
  [[file:~/TRAVAIL/github/guyader-lab-inra/org/journal.org::**Fin%20de%20configuration%20d'emacs%20OrgMode%20sur%20minipc%20perso*][*Fin de configuration d'emacs OrgMode sur minipc perso*]]
